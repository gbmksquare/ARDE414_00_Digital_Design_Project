//
//  MPParallaxImageViewController.swift
...
class MPParallaxImageViewController: UIViewController {
    ...
    // MARK: - Setup
    private func setup() {
        cardView.parallaxType = .basedOnHierarchyInParallaxView(parallaxOffsetMultiplier: 15)
